...
#undef XMVectorSplatConstantInt
    ...
    XMVECTOR    XM_CALLCONV     XMLoadVector3(const nc::Vector3* pSource) noexcept;
    XMVECTOR    XM_CALLCONV     XMLoadVector3A(const nc::Vector3* pSource) noexcept;
    ...
    XMVECTOR    XM_CALLCONV     XMLoadQuaternion(const nc::Quaternion* pSource) noexcept;
    ...
    void        XM_CALLCONV     XMStoreVector3(nc::Vector3* pDestination, FXMVECTOR V) noexcept;
    void        XM_CALLCONV     XMStoreVector3A(nc::Vector3* pDestination, FXMVECTOR V) noexcept;
    ...
    void        XM_CALLCONV     XMStoreQuaternion(nc::Quaternion* pDestination, FXMVECTOR V) noexcept;
